...
// tester array nums = [8,6,7,5,3,0,9]
//seleccted pivot value is 5
//pivot is now array index 0
//if lower than pivot, assign as new index 0 and push the rest of the array forward.  if it's not lower than my pivot,
//or is equal in value, then it stays where it is.
//return new index value of the pivot point
